...
import eu.telecom_bretagne.cabinet_recrutement.data.model.Secteuroffre;
import eu.telecom_bretagne.cabinet_recrutement.data.model.SecteuroffreId;
 ...
 */
@Stateless
public class SecteuroffreDAO {

    private static final Logger logger = Logger.getLogger(SecteuroffreDAO.class.getName());
